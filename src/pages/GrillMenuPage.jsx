        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-md mx-auto mb-6">
            <div className="relative">
              <input
                type="text"
                placeholder="Search grill items..."
                value={searchTerm}
          ...
          <div className="hidden sm:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {filteredItems.map((item) => (
              <div
                key={item._id}
                className={`rounded-xl shadow-lg p-4 flex flex-col items-center transition-all duration-300 hover:shadow-xl hover:scale-105 relative ${
                  item.outofstock 
                ...
                <p className={`mb-4 font-bold ${
                  ...
                  {item.promotion && item.promotion > 0 ? (
                    <>
                      ...
                      <br />
                      <span className={`pl-5 text-xs font-medium ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
