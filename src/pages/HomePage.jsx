...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-[500px]">
      <div className={`min-h-screen font-sans transition duration-300 ${darkMode ? "bg-gray-900 text-white" : "bg-gradient-to-b from-pink-50 via-white to-white text-gray-800"}`}>
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                    <div className="w-full max-w-md px-4">
                      <input
                        ...
                        className="w-full px-5 py-3 rounded-full border border-rose-500 shadow-lg bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-pink-400"
                      />
                    </div>
                  </div>
                </div>
        ...
        {/* CATEGORY MENU */}
        <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto relative">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
            {/* Cherry blossom petals with varying delays, sizes, and positions */}
